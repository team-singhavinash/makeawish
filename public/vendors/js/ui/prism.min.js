                ...
                for (var y = 0, b = 0; y < i.length; b += i[y].length, ++y) {
                  ...
                  if (!(v instanceof r)) {
                    ...
                    var w = g.exec(v),
                      k = 1;
                    if (!w && d && y != i.length - 1) {
                      if (((g.lastIndex = b), (w = g.exec(e)), !w)) break;
                      for (
                        var P = w.index + (p ? w[1].length : 0),
                        ...
                        (j += i[A].length), P >= j && (++y, (b = j));
                      if (i[y] instanceof r || i[A - 1].greedy) continue;
                      (k = A - y), (v = e.slice(b, j)), (w.index -= b);
                    }
                    if (w) {
                      p && (m = w[1].length);
                      var P = w.index + m,
